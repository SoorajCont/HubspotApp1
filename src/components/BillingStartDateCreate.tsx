...
interface Props {
  ...
  setInputData: Dispatch<SetStateAction<z.infer<typeof createLineItemSchema>>>;
}

const BillingStartDateCreate = ({ inputData, setInputData }: Props) => {
...
export default BillingStartDateCreate;
